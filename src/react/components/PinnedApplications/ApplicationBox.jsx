...
function ApplicationBox({ icon, name, link, removeFunction, id }) {
  const handleClick = () => chrome.tabs.create({ url: `https://` + link });

  return (
    <Container
      className="rounded-4 bg-custom-color-grey-light p-3 m-3 img-effect text-custom-color-grey-text-emphasis"
    ...
    >
      ...
      >
        <Row className="mt-0 mb-3">
          <div
            className="rounded-circle bg-custom-color-grey-lighter d-flex align-items-center justify-content-center"
